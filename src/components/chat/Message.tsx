...
const Message: FC<MessageProps> = ({message, isNextMessageIsSamePerson}) => {
  return (
    <div className={cn('flex items-end', {
      ...
      <div className={cn('flex flex-col space-y-2 text-base max-w-md mx-2', {
        ...
        <div className={cn('px-2 py-2 rounded-lg inline-block', {
          ...
          'rounded-br-none': !isNextMessageIsSamePerson && message.isUserMessage,
          'rounded-bl-none': !isNextMessageIsSamePerson && !message.isUserMessage,
        })}>
          ...
          {
            message.id !== -1 ? (
              <div className={cn('text-xs select-none mt-0.5 w-full text-right', {
